...
/*   Updated: 2020/07/30 11:02:22 by ocarlos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_phex(unsigned long int i, t_prtform *form, int swt);  // changed here
...
int				ft_countdig(unsigned long int n, int b);  // changed here
void			ft_revstr(char *s, int size);
char			*ft_itoabase(unsigned long int n, int b);  // changed here
void			ft_uppercase(char *s);
int				ft_vprintf(t_prtform *form, va_list lst, int count);
int				ft_redint(int n, t_prtform *form);
int				ft_redllint(unsigned long int n, t_prtform *form);  // changed here
