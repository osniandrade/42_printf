...
/*   Updated: 2020/07/21 16:25:23 by ocarlos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_phex(unsigned long long int i, t_prtform *form, int swt); //***mudar aqui
...
int				ft_countdig(unsigned long long int n, int b); //******************mudar aqui
void			ft_revstr(char *s, int size);
char			*ft_itoabase(unsigned long long int n, int b); //*****************mudar aqui
