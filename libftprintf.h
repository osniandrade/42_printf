...
/*   Updated: 2020/07/30 10:01:15 by ocarlos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_phex(uint64_t i, t_prtform *form, int swt);
int				ft_pint(long int i, t_prtform *form);
int				ft_pstr(char *s, t_prtform *form);
int				ft_puin(uint64_t i, t_prtform *form);
